      ...
      <Section id="reviews" variant="white">
        ...
        <div className="flex flex-wrap justify-center gap-10 opacity-60 grayscale hover:grayscale-0 transition-all duration-500 mb-16">
          {[1, 2, 3, 4, 5].map((i) => (
            <div
              key={i}
              className="text-2xl font-bold text-slate-400 flex items-center gap-2"
            >
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {[
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, x: 0 }}
            >
              <div className="text-brand-accent text-6xl absolute top-4 right-6 opacity-20">
                "
              </div>
              <p className="text-slate-700 text-lg italic mb-6 relative z-10">{review.text}</p>
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-slate-300 rounded-full overflow-hidden">
                  <img
                    src={`https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop&face&${i}`}
                    alt={review.name}
